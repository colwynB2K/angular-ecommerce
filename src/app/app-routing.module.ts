...
const routes: Routes = [
  {path: 'product-categories/:id', component: ProductListComponent},					// PATH HAS NO LEADING SLASHES!!!
  {path: 'product-categories', component: ProductListComponent},						// PATH HAS NO LEADING SLASHES!!!, no id param specified default id is used inside the component
